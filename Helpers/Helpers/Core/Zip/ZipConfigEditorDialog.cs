...
internal sealed class ZipConfigEditorDialog : Form
{
    ...
    private void SelectRootFiles(bool keepExisting)
    {
        ...
        string[] names =
        {
            Path.GetFileName(_solutionPath), ZipBuildConfig.FileName, "README.md", "LICENSE.txt", "LICENSE.md",
    ...
    private void SaveToConfig()
    {
        ...
        _config.ArchiveName = string.IsNullOrWhiteSpace(_txtArchiveName.Text) ? "VS.Helper.zip" : _txtArchiveName.Text.Trim();
